...
- [Document Knowledge Base](./cookbook/document-kb.md)
- [Research Papers & Code Repos](./cookbook/research-and-code.md)
- [Timeline Reconstruction](./cookbook/timeline.md)
- [Customer Support History](./cookbook/support-history.md)
- [Helios Scratchpad](./cookbook/helios-scratchpad.md)
...
- [Zep](./migrating/zep.md)
- [Cognee](./migrating/cognee.md)

# Protocol

- [MemoryProtocol 0.1 (HTTP/SSE)](./protocol/memoryprotocol-0.1.md)
- [Conformance](./protocol/conformance.md)

---

[Appendix: RFCs & Changelog](./appendix/index.md)
