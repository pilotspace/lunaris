...
| 8 | SDK / DX / integrations | partial(built-not-wired) | Python/TS SDKs + MCP (18 tools) ship, but LangGraph/CrewAI/Letta adapters are promised in docs yet absent in code |
...
| sdk-dx | Python/TS/Go SDKs + 13 framework integrations + hosted API | Python/TS SDKs + MCP (18 tools); LangGraph/CrewAI/Letta adapters promised but absent | crates/lunaris-py/src/lib.rs | https://docs.mem0.ai/integrations (2026-06-14) | partial(built-not-wired) | P1 |
...
(`npm i @pilotspace/lunaris`) ship full surfaces; `lunaris-mcp` ships 18 tools as a universal shim. But
