...
| 8 | SDK / DX / integrations | partial(built-not-wired) | Python/TS SDKs + MCP (20 tools) ship, but LangGraph/CrewAI/Letta adapters are promised in docs yet absent in code |
...
| sdk-dx | Python/TS/Go SDKs + 13 framework integrations + hosted API | Python/TS SDKs + MCP (20 tools); LangGraph/CrewAI/Letta adapters promised but absent | crates/lunaris-py/src/lib.rs | https://docs.mem0.ai/integrations (2026-06-14) | partial(built-not-wired) | P1 |
