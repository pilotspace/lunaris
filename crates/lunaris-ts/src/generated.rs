#![allow(clippy::needless_question_mark, clippy::let_unit_value)]
...
impl ChatAgentMemory {
    ...
    pub fn new(lunaris: &Lunaris, user_id: String) -> Self {
        ...
        let inner =
            ::lunaris_recipes::conversational::ChatAgentMemory::new(lunaris_owned, &user_id);
        Self { inner: Arc::new(inner) }
    }
...
impl MultiTurnConversation {
    ...
    pub fn new(lunaris: &Lunaris, user_id: String) -> Self {
        let lunaris_owned: ::std::sync::Arc<::lunaris::Lunaris> = lunaris.inner.clone();
        let inner =
            ::lunaris_recipes::conversational::MultiTurnConversation::new(lunaris_owned, &user_id);
        Self { inner: Arc::new(inner) }
    }
...
impl ResearchPaperCorpus {
    ...
    pub fn new(lunaris: &Lunaris, source_prefix: String) -> Self {
        let lunaris_owned: ::std::sync::Arc<::lunaris::Lunaris> = lunaris.inner.clone();
        let inner =
            ::lunaris_recipes::documentary::ResearchPaperCorpus::new(lunaris_owned, &source_prefix);
        Self { inner: Arc::new(inner) }
    }
...
impl CodeRepoMemory {
    ...
    pub fn new(lunaris: &Lunaris, repo_prefix: String) -> Self {
        let lunaris_owned: ::std::sync::Arc<::lunaris::Lunaris> = lunaris.inner.clone();
        let inner =
            ::lunaris_recipes::documentary::CodeRepoMemory::new(lunaris_owned, &repo_prefix);
        Self { inner: Arc::new(inner) }
    }
