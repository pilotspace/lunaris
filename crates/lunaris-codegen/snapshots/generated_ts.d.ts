...
export class ChatAgentMemory {
  ...
  static new(lunaris: Lunaris, scope: string, userId: string): this;
...
export class SlackArchive {
  ...
  static new(lunaris: Lunaris, scope: string): this;
...
export class DocumentKnowledgeBase {
  ...
  static new(lunaris: Lunaris, scope: string, sourcePrefix: string): this;
...
export class CodeRepoMemory {
  ...
  static new(lunaris: Lunaris, scope: string, repoPrefix: string): this;
