...
fn sixty_two_items_present() {
    ...
    // See extract.rs `sixty_two_surface_methods_present` for the full
    // per-module breakdown. Plan 8 surface (16) + Plan 11-02b
    // conversational (25) + Plan 11-02b documentary (21) = 62.
    assert_eq!(total, 62, "expected 62 surface methods, got {total}");
}
